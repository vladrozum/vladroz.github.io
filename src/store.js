    ...
    return (
      <div>
        <div className="containerCart">
          ...
          <div className={prevCart.price.toString().length===3? `priceCartBuy` : `priceCartBuyMore`}>
            {prevCart.price}
            <span className="priceCart">₴</span>
          </div>
        </div>
        ...
        if (pay) {
            ...
            <div className="containerOrder">
              {price > 3000 ? (
                <form className="form">
                  ...
                  />
                  <label className="label" htmlFor="cover">Коврик для Таро</label>
                  <br
                  />
                  ...
                  className="inputForm"
                    ...
                    onChange={handleChange}
                  />
                  <label htmlFor="nothing" className="label">Нічого не треба</label>
                  <br />
                </form>
              ) : (
                ""
          ...
          return (
            <div>
              ...
              <form>
                <label  className="inputs">
                  ...
                  <input
                    ...
                    onChange={(e) => setQuery(prevQuery => {
                      return {...prevQuery, phoneNumber: e.target.value}})}
                  />
                  <input
              ...
              <button onClick={zakaz} className="zamoviti">Замовити</button></div>
          ...
          return(
          <div className="containerOrder">
            <p className="thanks">{query.name} {query.lastName}, Дякую за покупку</p>
            <p className="number">Я вам зателефоную за номером {query.phoneNumber}</p>
            <p className="email">Деталі будуть надіслані на пошту {query.email}</p>
            <button onClick={closed} className="get">Отримати безкоштовну колоду моїх карт</button>
          </div>
          )
        }else if(block){
          return(
          ...
          <div className="blocked">
            ...
            <p>Щоб роблокувати, за допомогою карт дізнайтеся мій біткоін-гаманець і скиньте туди 500 BTC</p>
            </div></div>
          )
        }
